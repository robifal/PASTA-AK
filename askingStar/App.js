...
import TelaDificuldade from './src/pages/telaDificuldade/telaDificuldade';
...
const App = () => {
  ...
  return (
    ...
    <NavigationContainer >
      ...
      <Stack.Screen name="Materias" component={TelaMateria} />

      <Stack.Screen name="Dificuldade" component={TelaDificuldade} />
